...
public class EgresosServDocentesController {
     ...
     * public @ResponseBody double totalEgresosServDocentesEjecucion(int
     * idEjecucionPresupuestal) {
     * double total = 0;
     * Iterable<EgresosServDocentes> egresosServDocentes =
     * egresoServDocenteRepository
     ...
     * public @ResponseBody double totalEgresosServDocentesDePlantaEjecucion(int
     * idEjecucionPresupuestal) {
     * double total = 0;
     * Iterable<EgresosServDocentes> egresosServDocentes =
     * egresoServDocenteRepository
     ...
     * public @ResponseBody double totalEgresosServDocentesNoDePlantaEjecucion(int
     * idEjecucionPresupuestal) {
     * double total = 0;
     * Iterable<EgresosServDocentes> egresosServDocentes =
     * egresoServDocenteRepository
